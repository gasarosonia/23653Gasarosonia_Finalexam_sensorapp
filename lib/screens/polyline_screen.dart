...
import 'package:sensorapp/model/polyline_response.dart';
...
class _PolylineScreenState extends State<PolylineScreen> {
  static const CameraPosition initialPosition = CameraPosition(
      target: LatLng(-1.959949384811476, 30.092605216405385), zoom: 14);
  ...
  String apiKey = "AIzaSyBfMU8b1SpZ9yC1_yEw3ovmTd-yVeqpmKg";

  LatLng origin = const LatLng(-1.959949384811476, 30.092605216405385);
  LatLng destination = const LatLng(-1.959949384811476, 30.092605216405385);
